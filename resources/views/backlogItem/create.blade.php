{{-- Create Blade for backlog items --}}
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="bg-block mb-xl-5">
                    <form class="form-group" action="{{ route('backlogItem.store', ['project' => $project]) }}"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="sprint_id">Iteration</label>
                            <div class="col-sm-10">
                                <select class="form-control" id="sprint_id" name="sprint_id">
                                    ...
                                    @if(!is_null($sprints))
                                        ...
                                        @foreach($sprints as $sprint)
                                            <option value="{{ $sprint->iteration }}">{{ $sprint->iteration }}</option>
                                        @endforeach
                                    @else
                                        <option value=""></option>
                                    @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="4" name="acceptation_criteria"
                                          id="acceptation_criteria" form="bli_form"></textarea>
                            </div>
                        </div>
                        <h6>User Story:</h6>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="number" id="story_points" name="story_points" min="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 text-center">
                                <input type="submit" value="Add Backlog Item" class="prim-btn col-4">
                            </div>
                        </div>
                    </form>
                </div>
